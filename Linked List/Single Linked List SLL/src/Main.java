...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nLength is : " + list.length());   // Length is : 4
        System.out.println("Index of element 2 : " + list.search(2));   // Index of element 2 : 2

        // Delete Testing
        list.deleteAtIndex(1);  // [0,2,3]
        list.deleteTail();  // [0,2]
        list.deleteHead();  // [2]
        list.traverse(); // [2]
        System.out.println("\nLength is : " + list.length());   // Length is : 1
        System.out.println("Index of element 2 : " + list.search(1));   // Index of element 1 : -1
